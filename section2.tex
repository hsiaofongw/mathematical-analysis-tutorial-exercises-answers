...
\begin{equation}
    \lim_{x \to 0} x = 0
\end{equation}
所以$x$是当$x \to 0$时的无穷小．又因为
\begin{equation}
    \lim_{x \to 0} \displaystyle\frac{\sqrt{x^2+\sqrt[3]{x}}}{x} = \lim_{x \to 0} \displaystyle\sqrt{1 + \displaystyle\frac{\sqrt[3]{x}}{(\sqrt[3]{x})^3}} = 1
\end{equation}
所以当$x \to 0$时$x$与$\displaystyle\sqrt{x^2+\sqrt[3]{x}}$是同阶无穷小．又因为$x$是$1$阶无穷小，所以$\displaystyle\sqrt{x^2+\sqrt[3]{x}}$是$1$阶无穷小．\qed